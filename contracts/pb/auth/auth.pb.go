...
func (x *AuthResponse) GetB() string {
	if x != nil {
		return x.B
	}
	return ""
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\fAuthResponse\x12\f\n" +
	"\x01b\x18\x01 \x01(\tR\x01b2B\n" +
	"\x04Auth\x12:\n" +
	"\x11CreateCredentials\x12\x11.auth.AuthRequest\x1a\x12.auth.AuthResponseB\x1aZ\x18gobank/contracts/pb/authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: auth.Auth.CreateCredentials:input_type -> auth.AuthRequest
	1, // 1: auth.Auth.CreateCredentials:output_type -> auth.AuthResponse

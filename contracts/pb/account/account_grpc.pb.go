...
func (c *accountClient) CreateAccount(ctx context.Context, in *AccountRequest, opts ...grpc.CallOption) (*AccountResponse, error) {
...
func (UnimplementedAccountServer) CreateAccount(context.Context, *AccountRequest) (*AccountResponse, error) {
